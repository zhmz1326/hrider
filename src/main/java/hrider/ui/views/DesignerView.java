...
public class DesignerView {
    ...
    public DesignerView(final JPanel owner, final Connection connection) {
        ...
        rowsNumber.setModel(new SpinnerNumberModel(100, 1, 100000, 100));
        ...
        /*rowsTableModel.addTableModelListener(new TableModelListener() {
            @Override
                        ...
                        try {
                            ...
                            try {
                                ...
                                for (int i = 0; i < columns.size(); i++) {
                                    if (columns.get(i).getFullName().equals("c:exportFlag")) {
                                        updateColumn = i;
                                        break;
                                    }
                                }
